...
public class RandomPassword
{
    ...
    public int passwordLength { get { return _passwordLength; } set { _passwordLength = value; } }
    #endregion
    ...
    public RandomPassword(int lowercaseMin, int lowercaseMax, int uppercaseMin, int uppercaseMax, int specialMin, int specialMax, int numberMin, int numberMax, int passwordLength = 10)
    {
    ...
    {
        return GeneratePassword(_passwordLength);
    }
